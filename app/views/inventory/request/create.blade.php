...
@section("content")
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                {{ Form::label('test-category', Lang::choice('messages.requesting-facility', 1)) }}
                {{ Form::select('facility_id', $facilities, null, array('placeholder'=>'Optional','class' => 'form-control')) }}
            </div>
            <div class="form-group">
