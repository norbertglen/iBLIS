...
class Measure extends Eloquent {
	 ...
	 * @return count
	 */
	public function totalTestResults( $gender = null, $ageRange = null, $from = null, $to = null, $range = null, $positive = null, $option = null ) {
		...
		if($option){
			$testResults = $testResults->join( 'specimens', 'tests.specimen_id', '=', 'specimens.id' )
			                           ->where( 'sputum', $option );
		}
		if ( $to && $from ) {
